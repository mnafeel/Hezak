...
const envSchema = zod_1.z.object({
    ...
    PORT: zod_1.z
        ...
        .optional()
        .default('4000'),
    DATABASE_URL: zod_1.z.string().optional(), // Optional in Firebase Functions (using Firestore)
    ADMIN_EMAIL: zod_1.z.string().email('ADMIN_EMAIL must be a valid email address').optional(),
    ADMIN_PASSWORD_HASH: zod_1.z
        .string()
        .min(10, 'ADMIN_PASSWORD_HASH must be a valid bcrypt hash')
        .optional(),
    JWT_SECRET: zod_1.z.string().min(16, 'JWT_SECRET must be at least 16 characters long').optional()
});
